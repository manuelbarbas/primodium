...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_OFFCHAIN_TABLE, bytes14(""), bytes16("NewBattleResult")))
);
ResourceId constant NewBattleResultTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x00e0070220202020202020000000000000000000000000000000000000000000
);

struct NewBattleResultData {
...
library NewBattleResult {
   ...
   */
  function set(bytes32 battleId, NewBattleResultData memory _table) internal {
    bytes memory _staticData = encodeStatic(
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 battleId, NewBattleResultData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.aggressorEntity,
      _table.aggressorDamage,
      _table.targetEntity,
  ...
  ) internal pure returns (NewBattleResultData memory _table) {
    (
      _table.aggressorEntity,
      _table.aggressorDamage,
      _table.targetEntity,
