...
contract MirrorSubscriber is IStoreHook {
  ...
  function onAfterSpliceStaticData(ResourceId, bytes32[] memory keyTuple, uint48 start, bytes memory data) public {
  ...
  function onAfterDeleteRecord(ResourceId, bytes32[] memory keyTuple, FieldLayout) public {
