...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14("upgrade_bounty"), bytes16("SetItemUnitFacto")))
);
ResourceId constant SetItemUnitFactoriesTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0021020001200000000000000000000000000000000000000000000000000000
);

struct SetItemUnitFactoriesData {
  bool stored;
  uint256 index;
}

library SetItemUnitFactories {
  /**
   ...
   */
  function get(bytes32 entity, bytes32 building) internal view returns (SetItemUnitFactoriesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = entity;
    _keyTuple[1] = building;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 entity, bytes32 building) internal view returns (SetItemUnitFactoriesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = entity;
    _keyTuple[1] = building;
   ...
   */
  function set(bytes32 entity, bytes32 building, SetItemUnitFactoriesData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 entity, bytes32 building, SetItemUnitFactoriesData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.stored, _table.index);
  ...
  function decode(
    ...
    PackedCounter,
    bytes memory
  ) internal pure returns (SetItemUnitFactoriesData memory _table) {
