...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14("upgrade_bounty"), bytes16("SetUnitFactories")))
);
ResourceId constant SetUnitFactoriesTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0000000100000000000000000000000000000000000000000000000000000000
);

library SetUnitFactories {
  /**
