...
export const Objectives = new Map<EObjectives, Objective>([
  ...
  [
    EObjectives.BattleFleet,
    {
      type: "Claim",
      description:
        "Battling a fleet on an asteroid allows you to defend asteroids and steal resources. To battle, select a fleet or asteroid and press the Attack button. Then select the target fleet.",
      icon: "/img/icons/attackicon.png",
      tooltip: "Executed an attack",
    },
  ],
