...
export const BackgroundImage = new Map<Entity, string[]>([
  ...
  [EntityType.ColonyShip, ["/img/unit/miningvessel.png"]],
...
export const ResearchImage = new Map<Entity, string>([
  ...
  [EntityType.ColonyShipUpgrade1, "/img/unit/miningvessel.png"],
  [EntityType.ColonyShipUpgrade2, "/img/unit/miningvessel.png"],
  [EntityType.ColonyShipUpgrade3, "/img/unit/miningvessel.png"],
  [EntityType.ColonyShipUpgrade4, "/img/unit/miningvessel.png"],
  [EntityType.ColonyShipUpgrade5, "/img/unit/miningvessel.png"],
