...
export const RESOURCE_SCALE = BigInt(1e18);
...
export const EntityType = {
  ...
  GoldMine: toHex32("GoldMine") as Entity,
...
export const ResearchImage = new Map<Entity, string>([
  ...
  [EntityType.Gold, "/img/resource/sulfur_resource.png"],
...
export const ResourceEnumLookup: Record<Entity, EResource> = {
  ...
  [EntityType.Gold]: EResource.Gold,
...
export const BuildingEnumLookup: Record<Entity, EBuilding> = {
  ...
  [EntityType.GoldMine]: EBuilding.GoldMine,
