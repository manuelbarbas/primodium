...
export const GeneralSettings = () => {
  const [uiScale, setUiScale] = usePersistantStore((state) => [state.uiScale, state.setUiScale]);
  const [allowHackerModal, toggleAllowHackerModal] = usePersistantStore((state) => [
