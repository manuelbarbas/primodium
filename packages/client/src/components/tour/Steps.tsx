...
export const steps: Step[] = [
  ...
  ...buildRoute({
    ...
    narration: [
      <p>
        Welcome to Primodium, a dense and resource-rich planet. Your goal is to
        set up base, export materials, and defeat other parties.
        <br />
        <br />
        First, <b>open the building menu.</b>
      </p>,
      <p>
        Great work. You can access all your buildings in the building menu, for
        now, focus on building a base. Remember, location of our base is
  ...
  ...buildRoute({
    ...
    narration: [
      <p>
        Now it’s time to mine some iron. Iron is required for most buildings and
        items to set you up for early success.
        <br />
        <br />
  ...
  buildStep({
    ...
    checkpoint: true,
    hideUI: true,
    narration: <p>Place the miner on any of the highlighted iron deposits.</p>,
    customTooltipRenderer: () => {
      const spawn = useTourStore.getState().spawn;
  ...
  ...buildRoute({
    ...
    narration: [
      <p>
        Now that you have your nodes, you need to connect them. To do this, you
        need to build a <b>Conveyor</b> between the two nodes.
        <br />
        <br />
