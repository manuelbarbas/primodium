...
const SelectedTile: React.FC<{ tile: Coord }> = ({ tile: selectedTile }) => {
  const network = useMud();
  const { components, singletonIndex, perlin } = network;
      ...
      <div className="grid grid-cols-1 gap-1.5 overflow-y-scroll scrollbar">
        <div className="flex flex-col">
          <div className="flex align-center mb-4">
            {builtTile ? (
              <div
                ...
                style={{
                  backgroundImage: `url(${BackgroundImage.get(builtTile)!})`,
                        ...
                        {terrainTile.resource && (
                          <>
                            <img
                              ...
                              src={BackgroundImage.get(terrainTile.resource)}
                            />
          ...
          <div className="flex-row mt-2 mb-2">
            ...
            {builtTile && (
              <>
                {(isClaimable(builtTile) || isClaimableFactory(builtTile)) &&
