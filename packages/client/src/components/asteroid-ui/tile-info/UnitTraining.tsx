...
export const UnitTraining: React.FC<{
  ...
  const requiredHousing = useMemo(() => {
    ...
    if (!raw) return 0;
    const amountIndex = raw.resourceIDs.indexOf(BlockType.HousingUtilityResource);
            ...
            <>
              ...
              {requiredHousing > 0 && (
                <div className="flex justify-center items-center gap-2">
                  ...
                  <ResourceIconTooltip
                    image={ResourceImage.get(BlockType.HousingUtilityResource) ?? ""}
                    scale={1}
              ...
              <NumberInput min={0} max={(maximum - totalUnits) / requiredHousing} onChange={(val) => setCount(val)} />
