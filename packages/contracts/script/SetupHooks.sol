...
function registerBuildHooks(IWorld world) {
  ...
  world.grantAccess(ProducedResourceTableId, address(onBuild_ClaimResources));
...
function registerUpgradeHooks(IWorld world) {
  ...
  world.grantAccess(ProducedResourceTableId, address(onUpgrade_ClaimResources));
  world.registerSystemHook(getSystemResourceId("UpgradeBuildingSystem"), onUpgrade_ClaimResources, BEFORE_CALL_SYSTEM);
...
function registerDestroyHooks(IWorld world) {
  ...
  world.grantAccess(ProducedResourceTableId, address(onDestroy_ClaimResources));
...
function registerRaid(IWorld world) {
  ...
  world.registerSystemHook(getSystemResourceId("RaidSystem"), onRaid_TargetClaimResourcesAndUnits, BEFORE_CALL_SYSTEM);
}
