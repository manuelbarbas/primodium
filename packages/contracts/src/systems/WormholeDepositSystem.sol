...
import { OwnedBy, Position, P_WormholeConfig, P_WormholeConfigData, Wormhole, WormholeData, CooldownEnd } from "codegen/index.sol";
...
contract WormholeDepositSystem is PrimodiumSystem {
  ...
  //   CooldownEnd.set(wormholeEntity, block.timestamp + CooldownEnd.get(wormholeEntity));
