...
contract BuildSystem is PrimodiumSystem {
  ...
  {
    require(
      buildingType > EBuilding.NULL && buildingType < EBuilding.LENGTH,
    ...
    require(
      !Spawned.get(buildingEntity),
      "[BuildSystem] Building already exists"
    );
    ...
    require(
      LibBuilding.canBuildOnTile(buildingType, coord),
