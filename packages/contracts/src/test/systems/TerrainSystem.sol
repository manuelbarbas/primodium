...
contract BuildSystemTest is PrimodiumTest {
  ...
  function testTerrain() public {
    ...
    assertEq(LibTerrain.getResourceByCoord(world, Coord(7, 15, 0)), SulfurID);
    ...
    assertEq(LibTerrain.getResourceByCoord(world, Coord(10, 15, 0)), SulfurID);
    assertEq(LibTerrain.getResourceByCoord(world, Coord(11, 15, 0)), SulfurID);
