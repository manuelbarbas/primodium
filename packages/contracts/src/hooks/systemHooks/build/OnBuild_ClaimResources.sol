...
/**
 * @title OnBuild_ClaimResources
 * @dev This contract is a system hook that handles claiming resources when a building is constructed in the game world.
 */
contract OnBuild_ClaimResources is SystemHook {
  constructor() {}
