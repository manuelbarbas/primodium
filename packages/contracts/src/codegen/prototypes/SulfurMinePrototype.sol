...
bytes32 constant prototypeId = "SulfurMine";
bytes32 constant SulfurMinePrototypeId = prototypeId;
uint256 constant LENGTH = 2;

function SulfurMineKeys() pure returns (bytes32[] memory) {
...
function SulfurMinePrototype(IStore store) {
  bytes32[] memory keys = SulfurMineKeys();
