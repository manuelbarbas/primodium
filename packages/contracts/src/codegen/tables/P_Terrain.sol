...
// Import user types
import { EResource } from "./../Types.sol";

bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("P_Terrain")));
bytes32 constant P_TerrainTableId = _tableId;
...
library P_Terrain {
  ...
  /** Get value */
  function get(int32 x, int32 y) internal view returns (EResource value) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(int256(x)));
    _keyTuple[1] = bytes32(uint256(int256(y)));

    bytes memory _blob = StoreSwitch.getField(_tableId, _keyTuple, 0, getValueSchema());
    return EResource(uint8(Bytes.slice1(_blob, 0)));
  }
  ...
  function get(
    ...
    int32 x,
    int32 y
  ) internal view returns (EResource value) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(int256(x)));
    _keyTuple[1] = bytes32(uint256(int256(y)));
  ...
  function encode(EResource value) internal pure returns (bytes memory) {
