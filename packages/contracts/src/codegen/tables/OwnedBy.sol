...
library OwnedBy {
  ...
  /** Get owner */
  function get(bytes32 entity) internal view returns (bytes32 owner) {
  ...
  function get(IStore _store, bytes32 entity) internal view returns (bytes32 owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
  ...
  /** Set owner */
  function set(bytes32 entity, bytes32 owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
  ...
  function encode(bytes32 owner) internal pure returns (bytes memory) {
