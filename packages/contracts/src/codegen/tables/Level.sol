...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Level")));
bytes32 constant LevelTableId = _tableId;
...
library Level {
  ...
  function get(IStore _store, bytes32 entity) internal view returns (uint32 value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
