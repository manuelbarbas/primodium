...
library P_Asteroid {
  ...
  /** Get xBounds (using the specified store) */
  ...
  /** Get yBounds (using the specified store) */
  ...
  function set(int32 xBounds, int32 yBounds) internal {
    bytes memory _data = encode(xBounds, yBounds);
  ...
  function set(P_AsteroidData memory _table) internal {
    set(_table.xBounds, _table.yBounds);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, P_AsteroidData memory _table) internal {
    set(_store, _table.xBounds, _table.yBounds);
  }
