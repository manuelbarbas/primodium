...
uint256 constant TridentMarine = uint256(keccak256("unit.TridentMarine"));
...
uint256 constant StingerDrone = uint256(keccak256("unit.StingerDrone"));
uint256 constant AnvilDrone = uint256(keccak256("unit.AnvilDrone"));
