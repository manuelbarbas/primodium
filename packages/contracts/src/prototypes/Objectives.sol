...
uint256 constant BuildFirstIronMineID = uint256(keccak256("objective.BuildFirstIronMine"));
uint256 constant BuildFirstCopperMineID = uint256(keccak256("objective.BuildFirstCopperMine"));
uint256 constant BuildFirstLithiumMineID = uint256(keccak256("objective.BuildFirstLithiumMine"));
uint256 constant BuildFirstSulfurMineID = uint256(keccak256("objective.BuildFirstSulfurMine"));

uint256 constant BuildFirstIronPlateFactoryID = uint256(keccak256("objective.BuildFirstIronPlateFactory"));
uint256 constant BuildFirstAlloyFactoryID = uint256(keccak256("objective.BuildFirstAlloyFactory"));
...
uint256 constant TrainTridentMarineID = uint256(keccak256("objective.TrainTridentMarine"));
uint256 constant TrainTridentMarine2ID = uint256(keccak256("objective.TrainTridentMarine2"));
uint256 constant TrainTridentMarineI3D = uint256(keccak256("objective.TrainTridentMarine3"));
