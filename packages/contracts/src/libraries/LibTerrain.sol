...
library LibTerrain {
  ...
  function getPerlinSeed1() internal pure returns (int256) {
    return 60194;
  }

  function getPerlinSeed2() internal pure returns (int256) {
    return 74037;
  }

  function getPerlinSeed3() internal pure returns (int256) {
    return 53092;
  }

  function getPerlinSeed4() internal pure returns (int256) {
    return 17326;
  }
  ...
  function getTerrainNormalizedDepth(Coord memory coord) internal pure returns (int256) {
  ...
  function getTerrainKey(Coord memory coord) internal pure returns (uint256) {
  ...
  function avgResourceNormalizedDepth(int128 depth1, int128 depth2) internal pure returns (int256) {
    int128 resourceDepthSum = Math.add(depth1, depth2);
    return Math.muli(Math.div(resourceDepthSum, _4), 10000);
  }

  function getResourceNormalizedDepth(Coord memory coord) internal pure returns (int256) {
