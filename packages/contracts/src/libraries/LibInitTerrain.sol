...
terrainComponent.set(LibEncode.hashKeyCoord(TerrainKey, Coord(7, 15, 0)), SulfurID);
...
terrainComponent.set(LibEncode.hashKeyCoord(TerrainKey, Coord(10, 15, 0)), SulfurID);
terrainComponent.set(LibEncode.hashKeyCoord(TerrainKey, Coord(11, 15, 0)), SulfurID);
