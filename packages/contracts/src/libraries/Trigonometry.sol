...
library Trigonometry {
   ...
   */
  function sin(uint256 _angle) internal view returns (int256) {
    unchecked {
      ...
      console.log("isoddquadrant:", is_odd_quadrant);
      bool is_negative_quadrant = (_angle & QUADRANT_HIGH_MASK) != 0;
      console.log("isnegativequadrant:", is_negative_quadrant);
      if (!is_odd_quadrant) {
   ...
   * @return Result scaled by 1e18
   */
  function cos(uint256 _angle) internal view returns (int256) {
    unchecked {
