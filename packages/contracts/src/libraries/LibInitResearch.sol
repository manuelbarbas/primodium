...
library LibInitResearch {
  function init(IWorld world) internal {
    ...
    LevelComponent levelComponent = LevelComponent(world.getComponent(BuildingComponentID));
    ...
    requiredResources[0] = ResourceValue({ resource: CopperResourceItemID, value: 1000 });
