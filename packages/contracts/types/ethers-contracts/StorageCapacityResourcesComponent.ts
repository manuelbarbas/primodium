...
export interface StorageCapacityResourcesComponentInterface
...
export interface StorageCapacityResourcesComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StorageCapacityResourcesComponentInterface;
