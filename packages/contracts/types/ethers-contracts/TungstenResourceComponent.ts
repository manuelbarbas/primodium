...
export interface TungstenResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface TungstenResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TungstenResourceComponentInterface;
