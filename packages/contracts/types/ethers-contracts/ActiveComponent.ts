...
export interface ActiveComponentInterface extends utils.Interface {
  functions: {
...
export interface ActiveComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ActiveComponentInterface;
