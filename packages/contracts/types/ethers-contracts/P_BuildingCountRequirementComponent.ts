...
export interface P_BuildingCountRequirementComponentInterface
...
export interface P_BuildingCountRequirementComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_BuildingCountRequirementComponentInterface;
