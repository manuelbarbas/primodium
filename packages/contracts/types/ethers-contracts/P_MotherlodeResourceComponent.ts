...
export interface P_MotherlodeResourceComponentInterface
...
export interface P_MotherlodeResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_MotherlodeResourceComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint32))"(
      motherlodeResourceData: ResourceValueStruct,
