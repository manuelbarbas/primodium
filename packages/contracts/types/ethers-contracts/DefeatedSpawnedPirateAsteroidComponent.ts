...
export interface DefeatedSpawnedPirateAsteroidComponentInterface
...
export interface DefeatedSpawnedPirateAsteroidComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DefeatedSpawnedPirateAsteroidComponentInterface;
