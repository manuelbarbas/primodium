...
export interface BattleDefenderComponentInterface extends utils.Interface {
  functions: {
...
export interface BattleDefenderComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BattleDefenderComponentInterface;
