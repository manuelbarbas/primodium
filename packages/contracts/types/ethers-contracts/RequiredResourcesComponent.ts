...
export interface RequiredResourcesComponentInterface extends utils.Interface {
  functions: {
...
export interface RequiredResourcesComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RequiredResourcesComponentInterface;
