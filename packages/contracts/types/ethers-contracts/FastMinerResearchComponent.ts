...
export interface FastMinerResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface FastMinerResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FastMinerResearchComponentInterface;
