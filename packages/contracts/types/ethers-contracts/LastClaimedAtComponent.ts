...
export interface LastClaimedAtComponentInterface extends utils.Interface {
  functions: {
...
export interface LastClaimedAtComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LastClaimedAtComponentInterface;
