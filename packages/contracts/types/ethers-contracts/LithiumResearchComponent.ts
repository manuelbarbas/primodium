...
export interface LithiumResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface LithiumResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LithiumResearchComponentInterface;
