...
export interface P_HasBuiltBuildingComponentInterface extends utils.Interface {
  functions: {
...
export interface P_HasBuiltBuildingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_HasBuiltBuildingComponentInterface;
