...
export type ResourceValuesStruct = {
  resources: PromiseOrValue<BigNumberish>[];
  values: PromiseOrValue<BigNumberish>[];
};

export type ResourceValuesStructOutput = [BigNumber[], number[]] & {
  resources: BigNumber[];
  values: number[];
};

export interface P_RequiredUtilityComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, ResourceValuesStruct]
  ): string;
  encodeFunctionData(
...
export interface P_RequiredUtilityComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_RequiredUtilityComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256[],uint32[]))"(
      resources: ResourceValuesStruct,
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ResourceValuesStructOutput]>;
    ...
    "set(uint256,(uint256[],uint32[]))"(
      entity: PromiseOrValue<BigNumberish>,
      resourceValues: ResourceValuesStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
