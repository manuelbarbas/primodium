...
export interface BuildPathFromMineToMainBaseSystemInterface
...
export interface BuildPathFromMineToMainBaseSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuildPathFromMineToMainBaseSystemInterface;
