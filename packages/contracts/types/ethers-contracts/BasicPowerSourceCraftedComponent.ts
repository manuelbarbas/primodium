...
export interface BasicPowerSourceCraftedComponentInterface
...
export interface BasicPowerSourceCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BasicPowerSourceCraftedComponentInterface;
