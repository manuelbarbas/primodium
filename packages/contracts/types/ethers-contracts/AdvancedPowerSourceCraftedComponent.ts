...
export interface AdvancedPowerSourceCraftedComponentInterface
...
export interface AdvancedPowerSourceCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdvancedPowerSourceCraftedComponentInterface;
