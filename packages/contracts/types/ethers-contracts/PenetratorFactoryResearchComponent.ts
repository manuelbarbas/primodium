...
export interface PenetratorFactoryResearchComponentInterface
...
export interface PenetratorFactoryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PenetratorFactoryResearchComponentInterface;
