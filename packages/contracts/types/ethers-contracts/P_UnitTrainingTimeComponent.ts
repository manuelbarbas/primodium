...
export interface P_UnitTrainingTimeComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UnitTrainingTimeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitTrainingTimeComponentInterface;
