...
export interface ThermobaricMissileCraftedComponentInterface
...
export interface ThermobaricMissileCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThermobaricMissileCraftedComponentInterface;
