...
export interface IsDebugComponentInterface extends utils.Interface {
  functions: {
...
export interface IsDebugComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsDebugComponentInterface;
