...
export type ArrivalStruct = {
  sendType: PromiseOrValue<BigNumberish>;
  units: ArrivalUnitStruct[];
  arrivalBlock: PromiseOrValue<BigNumberish>;
...
export type ArrivalStructOutput = [
  ...
  sendType: number;
  units: ArrivalUnitStructOutput[];
  arrivalBlock: BigNumber;
  from: BigNumber;
  to: BigNumber;
  origin: BigNumber;
...
export interface ArrivalComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArrivalComponentInterface;
