...
export interface BulletCraftedComponentInterface extends utils.Interface {
  functions: {
...
export interface BulletCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BulletCraftedComponentInterface;
