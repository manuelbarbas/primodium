...
export interface CopperResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface CopperResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CopperResearchComponentInterface;
