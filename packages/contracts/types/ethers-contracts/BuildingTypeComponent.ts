...
export interface BuildingTypeComponentInterface extends utils.Interface {
  functions: {
...
export interface BuildingTypeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuildingTypeComponentInterface;
