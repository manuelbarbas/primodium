...
export interface MineableAtComponentInterface extends utils.Interface {
  functions: {
...
export interface MineableAtComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MineableAtComponentInterface;
