...
export interface P_UnitProductionTypesComponentInterface
...
export interface P_UnitProductionTypesComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitProductionTypesComponentInterface;
