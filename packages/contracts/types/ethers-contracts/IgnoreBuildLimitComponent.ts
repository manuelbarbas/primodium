...
export interface IgnoreBuildLimitComponentInterface extends utils.Interface {
  functions: {
...
export interface IgnoreBuildLimitComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IgnoreBuildLimitComponentInterface;
