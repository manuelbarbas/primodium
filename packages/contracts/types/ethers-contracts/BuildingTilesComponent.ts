...
export interface BuildingTilesComponentInterface extends utils.Interface {
  functions: {
...
export interface BuildingTilesComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuildingTilesComponentInterface;
