...
export interface MineProductionComponentInterface extends utils.Interface {
  functions: {
...
export interface MineProductionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MineProductionComponentInterface;
