...
export interface AdvancedBatteryFactoryResearchComponentInterface
...
export interface AdvancedBatteryFactoryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AdvancedBatteryFactoryResearchComponentInterface;
