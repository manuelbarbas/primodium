...
export interface P_MaxResourceStorageComponentInterface
...
export interface P_MaxResourceStorageComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_MaxResourceStorageComponentInterface;
