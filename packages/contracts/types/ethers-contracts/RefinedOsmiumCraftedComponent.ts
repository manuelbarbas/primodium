...
export interface RefinedOsmiumCraftedComponentInterface
...
export interface RefinedOsmiumCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RefinedOsmiumCraftedComponentInterface;
