...
export interface BattleSpaceRockComponentInterface extends utils.Interface {
  functions: {
...
export interface BattleSpaceRockComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BattleSpaceRockComponentInterface;
