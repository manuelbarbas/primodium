...
export interface P_TerrainComponentInterface extends utils.Interface {
  functions: {
...
export interface P_TerrainComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_TerrainComponentInterface;
