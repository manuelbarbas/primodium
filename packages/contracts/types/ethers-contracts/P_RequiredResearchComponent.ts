...
export interface P_RequiredResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface P_RequiredResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_RequiredResearchComponentInterface;
