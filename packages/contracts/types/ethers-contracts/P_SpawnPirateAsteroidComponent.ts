...
export interface P_SpawnPirateAsteroidComponentInterface
...
export interface P_SpawnPirateAsteroidComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_SpawnPirateAsteroidComponentInterface;
