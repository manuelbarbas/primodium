...
export interface KimberliteCatalystFactoryResearchComponentInterface
...
export interface KimberliteCatalystFactoryResearchComponent
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KimberliteCatalystFactoryResearchComponentInterface;
