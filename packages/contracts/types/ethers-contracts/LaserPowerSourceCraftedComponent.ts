...
export interface LaserPowerSourceCraftedComponentInterface
...
export interface LaserPowerSourceCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LaserPowerSourceCraftedComponentInterface;
