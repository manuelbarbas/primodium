...
export interface P_ScoreMultiplierComponentInterface extends utils.Interface {
  functions: {
...
export interface P_ScoreMultiplierComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_ScoreMultiplierComponentInterface;
