...
export interface BattleAttackerComponentInterface extends utils.Interface {
  functions: {
...
export interface BattleAttackerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BattleAttackerComponentInterface;
