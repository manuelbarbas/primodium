...
export interface P_UnitAttackComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UnitAttackComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitAttackComponentInterface;
