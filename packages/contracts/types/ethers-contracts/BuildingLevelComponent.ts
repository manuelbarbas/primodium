...
export interface BuildingLevelComponentInterface extends utils.Interface {
  functions: {
...
export interface BuildingLevelComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuildingLevelComponentInterface;
