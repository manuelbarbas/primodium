...
export interface PlayerProductionComponentInterface extends utils.Interface {
  functions: {
...
export interface PlayerProductionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlayerProductionComponentInterface;
