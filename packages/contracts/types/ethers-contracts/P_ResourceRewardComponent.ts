...
export interface P_ResourceRewardComponentInterface extends utils.Interface {
  functions: {
...
export interface P_ResourceRewardComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_ResourceRewardComponentInterface;
