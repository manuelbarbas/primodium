...
export interface MainBaseComponentInterface extends utils.Interface {
  functions: {
...
export interface MainBaseComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MainBaseComponentInterface;
