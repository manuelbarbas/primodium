...
export interface PrecisionPneumaticDrillResearchComponentInterface
...
export interface PrecisionPneumaticDrillResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrecisionPneumaticDrillResearchComponentInterface;
