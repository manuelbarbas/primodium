...
export interface LastResearchedAtComponentInterface extends utils.Interface {
  functions: {
...
export interface LastResearchedAtComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LastResearchedAtComponentInterface;
