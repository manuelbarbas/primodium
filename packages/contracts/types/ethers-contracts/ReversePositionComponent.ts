...
export interface ReversePositionComponentInterface extends utils.Interface {
  functions: {
...
export interface ReversePositionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReversePositionComponentInterface;
