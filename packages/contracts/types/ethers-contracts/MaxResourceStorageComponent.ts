...
export interface MaxResourceStorageComponentInterface extends utils.Interface {
  functions: {
...
export interface MaxResourceStorageComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MaxResourceStorageComponentInterface;
