...
export interface ThermobaricMissileFactoryResearchComponentInterface
...
export interface ThermobaricMissileFactoryResearchComponent
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThermobaricMissileFactoryResearchComponentInterface;
