...
export interface ArrivalsIndexComponentInterface extends utils.Interface {
  functions: {
...
export interface ArrivalsIndexComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArrivalsIndexComponentInterface;
