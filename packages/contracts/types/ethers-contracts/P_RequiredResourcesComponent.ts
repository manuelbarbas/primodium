...
export interface P_RequiredResourcesComponentInterface extends utils.Interface {
  functions: {
...
export interface P_RequiredResourcesComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_RequiredResourcesComponentInterface;
