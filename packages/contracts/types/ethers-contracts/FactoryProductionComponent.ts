...
export type FactoryProductionDataStruct = {
  ResourceID: PromiseOrValue<BigNumberish>;
  ResourceProductionRate: PromiseOrValue<BigNumberish>;
};

export type FactoryProductionDataStructOutput = [BigNumber, BigNumber] & {
  ResourceID: BigNumber;
  ResourceProductionRate: BigNumber;
};

export interface FactoryProductionComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [FactoryProductionDataStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, FactoryProductionDataStruct]
  ): string;
  encodeFunctionData(
...
export interface FactoryProductionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FactoryProductionComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint256))"(
      factoryProductionData: FactoryProductionDataStruct,
      overrides?: CallOverrides
    ): Promise<[BigNumber[]]>;
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[FactoryProductionDataStructOutput]>;
    ...
    "set(uint256,(uint256,uint256))"(
      entity: PromiseOrValue<BigNumberish>,
      value: FactoryProductionDataStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
