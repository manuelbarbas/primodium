...
export interface P_BuildingDefenceComponentInterface extends utils.Interface {
  functions: {
...
export interface P_BuildingDefenceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_BuildingDefenceComponentInterface;
