...
export interface TungstenResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface TungstenResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TungstenResearchComponentInterface;
