...
export interface P_MaxMovesComponentInterface extends utils.Interface {
  functions: {
...
export interface P_MaxMovesComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_MaxMovesComponentInterface;
