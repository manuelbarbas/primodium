...
export interface ThermobaricWarheadFactoryResearchComponentInterface
...
export interface ThermobaricWarheadFactoryResearchComponent
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThermobaricWarheadFactoryResearchComponentInterface;
