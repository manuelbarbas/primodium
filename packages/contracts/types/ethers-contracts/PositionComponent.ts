...
export interface PositionComponentInterface extends utils.Interface {
  functions: {
    ...
    "getEntitiesWithValue((int32,int32,uint256))": FunctionFragment;
    ...
    "set(uint256,int32,int32,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getEntitiesWithValue((int32,int32,uint256))"
      | "getRawValue"
      | "getSchema"
      | "getValue"
      | "has"
      ...
      | "registerWorld"
      | "remove"
      | "set(uint256,int32,int32,uint256)"
      | "set(uint256,bytes)"
      | "set(uint256,(int32,int32,uint256))"
      | "transferOwnership"
      | "unauthorizeWriter"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((int32,int32,uint256))",
    values: [CoordStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,int32,int32,uint256)",
    values: [
