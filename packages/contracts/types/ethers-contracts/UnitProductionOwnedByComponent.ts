...
export interface UnitProductionOwnedByComponentInterface
...
export interface UnitProductionOwnedByComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnitProductionOwnedByComponentInterface;
