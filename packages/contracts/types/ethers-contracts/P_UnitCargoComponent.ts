...
export interface P_UnitCargoComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UnitCargoComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitCargoComponentInterface;
