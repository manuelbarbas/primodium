...
export interface StorageCapacityComponentInterface extends utils.Interface {
  functions: {
...
export interface StorageCapacityComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StorageCapacityComponentInterface;
