...
export interface OccupiedPassiveResourceComponentInterface
...
export interface OccupiedPassiveResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OccupiedPassiveResourceComponentInterface;
