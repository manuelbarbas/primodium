...
export interface P_MaxLevelComponentInterface extends utils.Interface {
  functions: {
...
export interface P_MaxLevelComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_MaxLevelComponentInterface;
