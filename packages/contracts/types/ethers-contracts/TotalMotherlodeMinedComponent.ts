...
export interface TotalMotherlodeMinedComponentInterface
...
export interface TotalMotherlodeMinedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TotalMotherlodeMinedComponentInterface;
