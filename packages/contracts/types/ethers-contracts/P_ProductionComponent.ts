...
export interface P_ProductionComponentInterface extends utils.Interface {
  functions: {
...
export interface P_ProductionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_ProductionComponentInterface;
