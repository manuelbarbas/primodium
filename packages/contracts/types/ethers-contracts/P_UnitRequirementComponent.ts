...
export interface P_UnitRequirementComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UnitRequirementComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitRequirementComponentInterface;
