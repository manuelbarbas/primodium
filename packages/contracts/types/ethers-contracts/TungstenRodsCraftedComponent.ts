...
export interface TungstenRodsCraftedComponentInterface extends utils.Interface {
  functions: {
...
export interface TungstenRodsCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TungstenRodsCraftedComponentInterface;
