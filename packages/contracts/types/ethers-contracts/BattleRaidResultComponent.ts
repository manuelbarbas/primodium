...
export type RaidResultStruct = {
  resources: PromiseOrValue<BigNumberish>[];
  defenderValuesBeforeRaid: PromiseOrValue<BigNumberish>[];
  raidedAmount: PromiseOrValue<BigNumberish>[];
};

export type RaidResultStructOutput = [BigNumber[], number[], number[]] & {
  resources: BigNumber[];
  defenderValuesBeforeRaid: number[];
  raidedAmount: number[];
};

export interface BattleRaidResultComponentInterface extends utils.Interface {
  functions: {
    "authorizeWriter(address)": FunctionFragment;
    "getEntities()": FunctionFragment;
    "getEntitiesWithValue((uint256[],uint32[],uint32[]))": FunctionFragment;
    ...
    "set(uint256,(uint256[],uint32[],uint32[]))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "authorizeWriter"
      | "getEntities"
      | "getEntitiesWithValue((uint256[],uint32[],uint32[]))"
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint256[],uint32[],uint32[]))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint256[],uint32[],uint32[]))",
    values: [RaidResultStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256[],uint32[],uint32[]))",
    values: [PromiseOrValue<BigNumberish>, RaidResultStruct]
  ): string;
  encodeFunctionData(
...
export interface BattleRaidResultComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BattleRaidResultComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[RaidResultStructOutput]>;
