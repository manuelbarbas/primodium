...
export interface IridiumResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface IridiumResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IridiumResearchComponentInterface;
