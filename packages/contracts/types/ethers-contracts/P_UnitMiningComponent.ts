...
export interface P_UnitMiningComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UnitMiningComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitMiningComponentInterface;
