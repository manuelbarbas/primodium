...
export interface TitaniumResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface TitaniumResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TitaniumResourceComponentInterface;
