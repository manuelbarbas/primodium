...
export type MotherlodeStruct = {
  size: PromiseOrValue<BigNumberish>;
  motherlodeType: PromiseOrValue<BigNumberish>;
  cooldownBlocks: PromiseOrValue<BigNumberish>;
};

export type MotherlodeStructOutput = [number, number, BigNumber] & {
  size: number;
  motherlodeType: number;
  cooldownBlocks: BigNumber;
};

export interface MotherlodeComponentInterface extends utils.Interface {
  functions: {
    "authorizeWriter(address)": FunctionFragment;
    "getEntities()": FunctionFragment;
    "getEntitiesWithValue(bytes)": FunctionFragment;
    "getEntitiesWithValue((uint8,uint8,uint256))": FunctionFragment;
    ...
    "set(uint256,(uint8,uint8,uint256))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getEntitiesWithValue((uint8,uint8,uint256))"
      | "getRawValue"
      | "getSchema"
      | "getValue"
      | "has"
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint8,uint8,uint256))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint8,uint8,uint256))",
    values: [MotherlodeStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint8,uint8,uint256))",
    values: [PromiseOrValue<BigNumberish>, MotherlodeStruct]
  ): string;
  encodeFunctionData(
...
export interface MotherlodeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MotherlodeComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[MotherlodeStructOutput]>;
