...
export interface PassiveProductionComponentInterface extends utils.Interface {
  functions: {
...
export interface PassiveProductionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PassiveProductionComponentInterface;
