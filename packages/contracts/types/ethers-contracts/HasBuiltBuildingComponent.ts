...
export interface HasBuiltBuildingComponentInterface extends utils.Interface {
  functions: {
...
export interface HasBuiltBuildingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HasBuiltBuildingComponentInterface;
