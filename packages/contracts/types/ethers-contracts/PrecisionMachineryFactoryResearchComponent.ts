...
export interface PrecisionMachineryFactoryResearchComponentInterface
...
export interface PrecisionMachineryFactoryResearchComponent
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrecisionMachineryFactoryResearchComponentInterface;
