...
export type BattleParticipantStruct = {
  participantEntity: PromiseOrValue<BigNumberish>;
  unitTypes: PromiseOrValue<BigNumberish>[];
  unitLevels: PromiseOrValue<BigNumberish>[];
  unitCounts: PromiseOrValue<BigNumberish>[];
};

export type BattleParticipantStructOutput = [
  BigNumber,
  BigNumber[],
  number[],
  number[]
] & {
  participantEntity: BigNumber;
  unitTypes: BigNumber[];
  unitLevels: number[];
  unitCounts: number[];
};

export interface BattleParticipantComponentInterface extends utils.Interface {
  functions: {
    "authorizeWriter(address)": FunctionFragment;
    "getEntities()": FunctionFragment;
    "getEntitiesWithValue((uint256,uint256[],uint32[],uint32[]))": FunctionFragment;
    ...
    "set(uint256,(uint256,uint256[],uint32[],uint32[]))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "authorizeWriter"
      | "getEntities"
      | "getEntitiesWithValue((uint256,uint256[],uint32[],uint32[]))"
      ...
      | "registerWorld"
      | "remove"
      | "set(uint256,(uint256,uint256[],uint32[],uint32[]))"
      | "set(uint256,bytes)"
      | "set(uint256,uint256,uint256[],uint32[],uint32[])"
      | "transferOwnership"
      | "unauthorizeWriter"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint256,uint256[],uint32[],uint32[]))",
    values: [BattleParticipantStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,uint256[],uint32[],uint32[]))",
    values: [PromiseOrValue<BigNumberish>, BattleParticipantStruct]
  ): string;
  encodeFunctionData(
...
export interface BattleParticipantComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BattleParticipantComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint256[],uint32[],uint32[]))"(
      result: BattleParticipantStruct,
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BattleParticipantStructOutput]>;
