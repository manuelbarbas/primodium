...
export interface P_MaxStorageComponentInterface extends utils.Interface {
  functions: {
...
export interface P_MaxStorageComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_MaxStorageComponentInterface;
