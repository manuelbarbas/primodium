...
export interface HighEnergyLaserFactoryResearchComponentInterface
...
export interface HighEnergyLaserFactoryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HighEnergyLaserFactoryResearchComponentInterface;
