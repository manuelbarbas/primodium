...
export interface P_ObjectiveRequirementComponentInterface
...
export interface P_ObjectiveRequirementComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_ObjectiveRequirementComponentInterface;
