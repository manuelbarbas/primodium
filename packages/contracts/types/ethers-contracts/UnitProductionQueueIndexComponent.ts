...
export interface UnitProductionQueueIndexComponentInterface
...
export interface UnitProductionQueueIndexComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnitProductionQueueIndexComponentInterface;
