...
export type RequiredPassiveResourceDataStruct = {
  ResourceIDs: PromiseOrValue<BigNumberish>[];
  RequiredAmounts: PromiseOrValue<BigNumberish>[];
};

export type RequiredPassiveResourceDataStructOutput = [
  BigNumber[],
  BigNumber[]
] & { ResourceIDs: BigNumber[]; RequiredAmounts: BigNumber[] };

export interface RequiredPassiveResourceComponentInterface
  ...
  encodeFunctionData(
    ...
    values: [RequiredPassiveResourceDataStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, RequiredPassiveResourceDataStruct]
  ): string;
  encodeFunctionData(
...
export interface RequiredPassiveResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RequiredPassiveResourceComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256[],uint256[]))"(
      factoryMineBuildingsData: RequiredPassiveResourceDataStruct,
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[RequiredPassiveResourceDataStructOutput]>;
    ...
    "set(uint256,(uint256[],uint256[]))"(
      entity: PromiseOrValue<BigNumberish>,
      value: RequiredPassiveResourceDataStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
