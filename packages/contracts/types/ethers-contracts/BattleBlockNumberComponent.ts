...
export interface BattleBlockNumberComponentInterface extends utils.Interface {
  functions: {
...
export interface BattleBlockNumberComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BattleBlockNumberComponentInterface;
