...
export interface PirateComponentInterface extends utils.Interface {
  functions: {
...
export interface PirateComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PirateComponentInterface;
