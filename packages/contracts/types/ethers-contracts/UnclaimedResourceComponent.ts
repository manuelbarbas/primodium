...
export interface UnclaimedResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface UnclaimedResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnclaimedResourceComponentInterface;
