...
export interface MotherlodeResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface MotherlodeResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MotherlodeResourceComponentInterface;
