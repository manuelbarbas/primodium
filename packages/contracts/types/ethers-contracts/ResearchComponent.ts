...
export interface ResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface ResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResearchComponentInterface;
