...
export interface OccupiedUtilityResourceComponentInterface
...
export interface OccupiedUtilityResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OccupiedUtilityResourceComponentInterface;
