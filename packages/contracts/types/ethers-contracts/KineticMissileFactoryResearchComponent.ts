...
export interface KineticMissileFactoryResearchComponentInterface
...
export interface KineticMissileFactoryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KineticMissileFactoryResearchComponentInterface;
