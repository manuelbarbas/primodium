...
export type FactoryMineBuildingsDataStruct = {
  MineBuildingIDs: PromiseOrValue<BigNumberish>[];
  MineBuildingCount: PromiseOrValue<BigNumberish>[];
};

export type FactoryMineBuildingsDataStructOutput = [
  BigNumber[],
  BigNumber[]
] & { MineBuildingIDs: BigNumber[]; MineBuildingCount: BigNumber[] };

export interface FactoryMineBuildingsComponentInterface
  ...
  encodeFunctionData(
    ...
    values: [FactoryMineBuildingsDataStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, FactoryMineBuildingsDataStruct]
  ): string;
  encodeFunctionData(
...
export interface FactoryMineBuildingsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FactoryMineBuildingsComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256[],uint256[]))"(
      factoryMineBuildingsData: FactoryMineBuildingsDataStruct,
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[FactoryMineBuildingsDataStructOutput]>;
    ...
    "set(uint256,(uint256[],uint256[]))"(
      entity: PromiseOrValue<BigNumberish>,
      value: FactoryMineBuildingsDataStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
