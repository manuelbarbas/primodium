...
export interface BuildPathFromMineToFactorySystemInterface
...
export interface BuildPathFromMineToFactorySystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuildPathFromMineToFactorySystemInterface;
