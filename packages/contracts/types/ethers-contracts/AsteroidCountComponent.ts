...
export interface AsteroidCountComponentInterface extends utils.Interface {
  functions: {
...
export interface AsteroidCountComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AsteroidCountComponentInterface;
