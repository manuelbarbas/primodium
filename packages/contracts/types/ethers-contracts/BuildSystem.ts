...
export interface BuildSystemInterface extends utils.Interface {
  functions: {
    "execute(bytes)": FunctionFragment;
    "executeTyped(uint256,(int32,int32,uint256))": FunctionFragment;
...
export interface BuildSystem extends BaseContract {
