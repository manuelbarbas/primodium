...
export interface P_UtilityProductionComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UtilityProductionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UtilityProductionComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint32))"(
      resourceValue: ResourceValueStruct,
