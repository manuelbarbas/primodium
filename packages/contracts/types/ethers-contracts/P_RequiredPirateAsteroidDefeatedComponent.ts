...
export interface P_RequiredPirateAsteroidDefeatedComponentInterface
...
export interface P_RequiredPirateAsteroidDefeatedComponent
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_RequiredPirateAsteroidDefeatedComponentInterface;
