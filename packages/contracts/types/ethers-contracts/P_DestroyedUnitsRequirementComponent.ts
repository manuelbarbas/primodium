...
export interface P_DestroyedUnitsRequirementComponentInterface
...
export interface P_DestroyedUnitsRequirementComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_DestroyedUnitsRequirementComponentInterface;
