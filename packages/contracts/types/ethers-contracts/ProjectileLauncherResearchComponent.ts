...
export interface ProjectileLauncherResearchComponentInterface
...
export interface ProjectileLauncherResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProjectileLauncherResearchComponentInterface;
