...
export interface AsteroidTypeComponentInterface extends utils.Interface {
  functions: {
    "authorizeWriter(address)": FunctionFragment;
    "getEntities()": FunctionFragment;
    "getEntitiesWithValue(uint8)": FunctionFragment;
    ...
    "set(uint256,uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue(uint8)",
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,uint8)",
...
export interface AsteroidTypeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AsteroidTypeComponentInterface;
