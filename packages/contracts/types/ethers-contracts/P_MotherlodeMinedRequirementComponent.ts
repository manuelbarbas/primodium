...
export interface P_MotherlodeMinedRequirementComponentInterface
...
export interface P_MotherlodeMinedRequirementComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_MotherlodeMinedRequirementComponentInterface;
