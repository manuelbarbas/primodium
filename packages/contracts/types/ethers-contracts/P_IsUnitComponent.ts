...
export interface P_IsUnitComponentInterface extends utils.Interface {
  functions: {
...
export interface P_IsUnitComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_IsUnitComponentInterface;
