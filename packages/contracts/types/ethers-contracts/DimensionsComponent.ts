...
export type DimensionsStructOutput = [number, number] & {
  x: number;
  y: number;
};

export interface DimensionsComponentInterface extends utils.Interface {
  functions: {
...
export interface DimensionsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DimensionsComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[DimensionsStructOutput]>;
