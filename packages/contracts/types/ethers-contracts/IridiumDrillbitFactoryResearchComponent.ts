...
export interface IridiumDrillbitFactoryResearchComponentInterface
...
export interface IridiumDrillbitFactoryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IridiumDrillbitFactoryResearchComponentInterface;
