...
export interface PenetratingMissileCraftedComponentInterface
...
export interface PenetratingMissileCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PenetratingMissileCraftedComponentInterface;
