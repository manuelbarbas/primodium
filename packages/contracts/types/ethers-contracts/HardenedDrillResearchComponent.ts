...
export interface HardenedDrillResearchComponentInterface
...
export interface HardenedDrillResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HardenedDrillResearchComponentInterface;
