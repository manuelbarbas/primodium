...
export interface LastBuiltAtComponentInterface extends utils.Interface {
  functions: {
...
export interface LastBuiltAtComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LastBuiltAtComponentInterface;
