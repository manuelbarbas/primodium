...
export interface P_UnitLevelUpgradeComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UnitLevelUpgradeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitLevelUpgradeComponentInterface;
