...
export interface P_IsTechComponentInterface extends utils.Interface {
  functions: {
...
export interface P_IsTechComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_IsTechComponentInterface;
