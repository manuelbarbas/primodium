...
export interface MissileLaunchComplexResearchComponentInterface
...
export interface MissileLaunchComplexResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MissileLaunchComplexResearchComponentInterface;
