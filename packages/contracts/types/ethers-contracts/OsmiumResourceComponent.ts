...
export interface OsmiumResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface OsmiumResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OsmiumResourceComponentInterface;
