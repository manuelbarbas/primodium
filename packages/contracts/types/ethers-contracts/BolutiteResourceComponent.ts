...
export interface BolutiteResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface BolutiteResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BolutiteResourceComponentInterface;
