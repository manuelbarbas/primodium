...
export interface UraniniteResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface UraniniteResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UraniniteResourceComponentInterface;
