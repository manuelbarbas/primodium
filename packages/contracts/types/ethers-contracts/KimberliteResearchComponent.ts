...
export interface KimberliteResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface KimberliteResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KimberliteResearchComponentInterface;
