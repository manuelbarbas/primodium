...
export interface DenseMetalRefineryResearchComponentInterface
...
export interface DenseMetalRefineryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DenseMetalRefineryResearchComponentInterface;
