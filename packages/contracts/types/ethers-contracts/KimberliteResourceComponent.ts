...
export interface KimberliteResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface KimberliteResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KimberliteResourceComponentInterface;
