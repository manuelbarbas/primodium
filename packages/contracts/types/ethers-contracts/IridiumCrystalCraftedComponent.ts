...
export interface IridiumCrystalCraftedComponentInterface
...
export interface IridiumCrystalCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IridiumCrystalCraftedComponentInterface;
