...
export interface ThermobaricWarheadCraftedComponentInterface
...
export interface ThermobaricWarheadCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThermobaricWarheadCraftedComponentInterface;
