...
export interface HasCompletedObjectiveComponentInterface
...
export interface HasCompletedObjectiveComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HasCompletedObjectiveComponentInterface;
