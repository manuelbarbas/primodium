...
export interface P_UnitDefenceComponentInterface extends utils.Interface {
  functions: {
...
export interface P_UnitDefenceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_UnitDefenceComponentInterface;
