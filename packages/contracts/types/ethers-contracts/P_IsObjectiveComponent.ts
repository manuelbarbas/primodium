...
export interface P_IsObjectiveComponentInterface extends utils.Interface {
  functions: {
...
export interface P_IsObjectiveComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_IsObjectiveComponentInterface;
