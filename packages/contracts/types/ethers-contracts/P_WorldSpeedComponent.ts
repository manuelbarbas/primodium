...
export interface P_WorldSpeedComponentInterface extends utils.Interface {
  functions: {
...
export interface P_WorldSpeedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_WorldSpeedComponentInterface;
