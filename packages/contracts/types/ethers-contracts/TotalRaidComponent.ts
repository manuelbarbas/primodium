...
export interface TotalRaidComponentInterface extends utils.Interface {
  functions: {
...
export interface TotalRaidComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TotalRaidComponentInterface;
