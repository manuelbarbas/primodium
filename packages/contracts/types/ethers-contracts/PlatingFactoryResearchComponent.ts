...
export interface PlatingFactoryResearchComponentInterface
...
export interface PlatingFactoryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlatingFactoryResearchComponentInterface;
