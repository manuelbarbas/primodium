...
export interface P_RequiredTileComponentInterface extends utils.Interface {
  functions: {
...
export interface P_RequiredTileComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_RequiredTileComponentInterface;
