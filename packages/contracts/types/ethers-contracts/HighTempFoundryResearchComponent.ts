...
export interface HighTempFoundryResearchComponentInterface
...
export interface HighTempFoundryResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HighTempFoundryResearchComponentInterface;
