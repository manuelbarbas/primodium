...
export type BattleResultStruct = {
  winnerEntity: PromiseOrValue<BigNumberish>;
  attackerUnitsLeft: PromiseOrValue<BigNumberish>[];
  defenderUnitsLeft: PromiseOrValue<BigNumberish>[];
};

export type BattleResultStructOutput = [BigNumber, number[], number[]] & {
  winnerEntity: BigNumber;
  attackerUnitsLeft: number[];
  defenderUnitsLeft: number[];
};

export interface BattleResultComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, BattleResultStruct]
  ): string;
  encodeFunctionData(
...
export interface BattleResultComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BattleResultComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BattleResultStructOutput]>;
