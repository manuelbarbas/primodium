...
export interface IridiumResourceComponentInterface extends utils.Interface {
  functions: {
...
export interface IridiumResourceComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IridiumResourceComponentInterface;
