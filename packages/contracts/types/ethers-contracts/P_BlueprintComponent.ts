...
export interface P_BlueprintComponentInterface extends utils.Interface {
  functions: {
...
export interface P_BlueprintComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: P_BlueprintComponentInterface;
