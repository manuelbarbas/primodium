...
export interface OsmiumResearchComponentInterface extends utils.Interface {
  functions: {
...
export interface OsmiumResearchComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OsmiumResearchComponentInterface;
