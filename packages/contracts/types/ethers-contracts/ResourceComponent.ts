...
export type ResourceRowStruct = {
  resourceOwner: PromiseOrValue<BigNumberish>;
  resourceType: PromiseOrValue<BigNumberish>;
  resourceCount: PromiseOrValue<BigNumberish>;
};

export type ResourceRowStructOutput = [BigNumber, BigNumber, BigNumber] & {
  resourceOwner: BigNumber;
  resourceType: BigNumber;
  resourceCount: BigNumber;
};
...
export interface ResourceComponentInterface extends utils.Interface {
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint256,uint256))": FunctionFragment;
    ...
    "set(uint256,(uint256,uint256,uint256))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "authorizeWriter"
      | "getEntities"
      | "getEntitiesWithValue((uint256,uint256,uint256))"
      ...
      | "registerWorld"
      | "remove"
      | "set(uint256,(uint256,uint256,uint256))"
      | "set(uint256,bytes)"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint256,uint256,uint256))",
    values: [ResourceRowStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,uint256,uint256))",
    values: [PromiseOrValue<BigNumberish>, ResourceRowStruct]
  ): string;
  encodeFunctionData(
...
export interface ResourceComponent extends BaseContract {
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ResourceRowStructOutput]>;
