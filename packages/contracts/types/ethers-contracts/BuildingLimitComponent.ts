...
export interface BuildingLimitComponentInterface extends utils.Interface {
  functions: {
...
export interface BuildingLimitComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuildingLimitComponentInterface;
