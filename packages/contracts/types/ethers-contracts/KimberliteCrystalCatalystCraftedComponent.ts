...
export interface KimberliteCrystalCatalystCraftedComponentInterface
...
export interface KimberliteCrystalCatalystCraftedComponent
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KimberliteCrystalCatalystCraftedComponentInterface;
