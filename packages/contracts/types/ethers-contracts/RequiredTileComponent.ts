...
export interface RequiredTileComponentInterface extends utils.Interface {
  functions: {
...
export interface RequiredTileComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RequiredTileComponentInterface;
