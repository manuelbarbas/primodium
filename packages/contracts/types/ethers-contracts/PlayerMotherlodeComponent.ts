...
export interface PlayerMotherlodeComponentInterface extends utils.Interface {
  functions: {
...
export interface PlayerMotherlodeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlayerMotherlodeComponentInterface;
