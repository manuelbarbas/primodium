...
export interface PenetratingMissileFactoryResearchComponentInterface
...
export interface PenetratingMissileFactoryResearchComponent
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PenetratingMissileFactoryResearchComponentInterface;
