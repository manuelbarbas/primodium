...
export interface MaxLevelComponentInterface extends utils.Interface {
  functions: {
...
export interface MaxLevelComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MaxLevelComponentInterface;
