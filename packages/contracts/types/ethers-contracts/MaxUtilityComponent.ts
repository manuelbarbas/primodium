...
export interface MaxUtilityComponentInterface extends utils.Interface {
  functions: {
...
export interface MaxUtilityComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MaxUtilityComponentInterface;
