...
export interface PenetratingWarheadCraftedComponentInterface
...
export interface PenetratingWarheadCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PenetratingWarheadCraftedComponentInterface;
