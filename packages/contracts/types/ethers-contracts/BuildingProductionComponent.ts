...
export interface BuildingProductionComponentInterface extends utils.Interface {
  functions: {
...
export interface BuildingProductionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuildingProductionComponentInterface;
