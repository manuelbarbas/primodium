...
export interface IronPlateCraftedComponentInterface extends utils.Interface {
  functions: {
...
export interface IronPlateCraftedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IronPlateCraftedComponentInterface;
