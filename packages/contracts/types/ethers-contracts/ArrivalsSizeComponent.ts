...
export interface ArrivalsSizeComponentInterface extends utils.Interface {
  functions: {
...
export interface ArrivalsSizeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArrivalsSizeComponentInterface;
