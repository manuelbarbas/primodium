...
export const prototypeConfig: PrototypesConfig<typeof config> = {
  ...
  TitaniumSupply: marketplaceSupplyTable(EResource.Titanium, 1, 1e4),
  PlatinumSupply: marketplaceSupplyTable(EResource.Platinum, 1, 1e4),
  IridiumSupply: marketplaceSupplyTable(EResource.Iridium, 1, 1e4),
