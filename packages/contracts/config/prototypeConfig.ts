...
export const prototypeConfig: PrototypesConfig<typeof config> = {
  ...
  TitaniumSupply: marketplaceSupplyTable(EResource.Titanium, 1, 1e6),
  PlatinumSupply: marketplaceSupplyTable(EResource.Platinum, 1, 1e6),
  IridiumSupply: marketplaceSupplyTable(EResource.Iridium, 1, 1e6),
