...
export const prototypeConfig: PrototypesConfig<(typeof worldInput)["tables"]> = {
  ...
  AegisDrone: {
    ...
    levels: {
      0: {
        P_RequiredResources: getResourceValues({ Iron: 400, IronPlate: 100, Titanium: 5, U_Housing: 3 }),
        P_Unit: getPUnitData({
          hp: 600,
          attack: 100,
          defense: 500,
  ...
  StingerDrone: {
    ...
    levels: {
      0: {
        P_RequiredResources: getResourceValues({ Lithium: 400, PVCell: 100, Platinum: 5, U_Housing: 3 }),
        P_Unit: getPUnitData({
          hp: 500,
          attack: 600,
          defense: 75,
